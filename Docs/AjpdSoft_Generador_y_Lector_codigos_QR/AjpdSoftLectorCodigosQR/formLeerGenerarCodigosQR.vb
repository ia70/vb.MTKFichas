...
Public Class formLeerGenerarCodigosQR
    ...
    Private Sub btImprimirQR_Click(sender As System.Object, e As System.EventArgs) Handles btImprimirQR.Click
        If IsNothing(imgQR.Image) Then
    ...
    Private Sub PrintDocument1_PrintPage(sender As System.Object, e As System.Drawing.Printing.PrintPageEventArgs) Handles imprimirDoc.PrintPage
    ...
    Private Sub tabFormatoQR_SelectedIndexChanged(sender As System.Object, e As System.EventArgs) Handles tabFormatoQR.SelectedIndexChanged
