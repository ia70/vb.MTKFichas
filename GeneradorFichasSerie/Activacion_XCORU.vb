...
#Region "Varibles Generales"
    ...
    Private _Lic_Password_Encriptation As String = "@xCo2-a*pp_+XXb?1"

    'Encabezado y pie de Codigo de activación
    Private _Lic_Inicio As String = "*@a8<"
    Private _Lic_Fin As String = "--@0Q"

    'Encabezado y pie de Codigo de solicitud
    Private _Request_Ini As String = "@xru<"
    Private _Request_Fin As String = "-@!_h"
